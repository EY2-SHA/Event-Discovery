...
<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
  ...
  <div className="absolute inset-0">
    ...
    <div className="absolute inset-0 bg-gradient-to-b from-light-background/10 via-light-background/30 to-light-background/30 dark:from-dark-background/70 dark:via-dark-background/80 dark:to-dark-background"></div>
  </div>
