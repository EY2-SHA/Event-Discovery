    ...
    <div className="pt-24 min-h-screen">
      <div className="max-w-8xl mx-auto px-8 sm:px-12 lg:px-16">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="font-display font-bold text-3xl md:text-4xl text-light-foreground dark:text-dark-foreground mb-4">
            Curated Just{' '}
        ...
        <section className="mb-16">
          <div className="flex items-center space-x-3 mb-8">
            <div className="w-8 h-8 bg-light-secondary dark:bg-dark-secondary rounded-handcrafted flex items-center justify-center shadow-handcrafted">
              <Sparkles className="w-4 h-4 text-white" />
            </div>
            <div>
              <h2 className="font-display font-semibold text-xl text-light-foreground dark:text-dark-foreground">
                Perfect Matches
              </h2>
              ...
              >
                <div className={`bg-light-card dark:bg-dark-card overflow-hidden border-2 border-light-border dark:border-dark-border hover:border-light-secondary dark:hover:border-dark-secondary transition-all duration-300 shadow-brutal hover:shadow-brutal-lg transform hover:-translate-y-2 relative hover:animate-sketch ${
                  ...
                  <div className="absolute top-4 right-4 z-10">
                    <div className="px-3 py-1 bg-light-secondary dark:bg-dark-secondary text-white text-xs font-sans font-semibold rounded-sketch shadow-handcrafted">
                  ...
                  <div className="aspect-video relative overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1 bg-light-background/90 dark:bg-dark-background/90 text-light-foreground dark:text-dark-foreground text-xs font-sans font-medium rounded-sketch shadow-handcrafted">
                        {event.category}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 space-y-3">
                    <h3 className="font-display font-semibold text-lg text-light-foreground dark:text-dark-foreground group-hover:text-light-secondary dark:group-hover:text-dark-secondary transition-colors">
                      {event.title}
                    </h3>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-sans font-semibold text-light-foreground dark:text-dark-foreground text-sm">
                          {event.price}
                        </span>
                      </div>
                    </div>
            ...
            {trendingEvents.map((event) => (
              ...
              >
                <div className="bg-light-card dark:bg-dark-card overflow-hidden border-2 border-light-border dark:border-dark-border hover:border-light-secondary dark:hover:border-dark-secondary transition-all duration-300 shadow-brutal hover:shadow-brutal-lg transform hover:-translate-y-2 relative hover:animate-sketch">
                  {/* Trending Badge */}
                  <div className="absolute top-4 right-4 z-10">
                    <div className="px-3 py-1 bg-red-500 text-white text-xs font-sans font-semibold rounded-sketch shadow-handcrafted flex items-center space-x-1">
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <button className="w-full py-2 border border-light-secondary dark:border-dark-secondary text-light-secondary dark:text-dark-secondary font-sans font-medium hover:bg-light-secondary dark:hover:bg-dark-secondary hover:text-white transition-all duration-300 rounded-handcrafted shadow-handcrafted text-sm">
                      View Details
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-light-card dark:bg-dark-card overflow-hidden border-2 border-light-border dark:border-dark-border hover:border-light-secondary dark:hover:border-dark-secondary transition-all duration-300 shadow-brutal hover:shadow-brutal-lg transform hover:-translate-y-2 flex hover:animate-sketch">
                  ...
                  <div className="w-2/3 p-4 flex flex-col justify-between">
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="px-3 py-1 bg-light-secondary dark:bg-dark-secondary text-white text-xs font-sans font-medium rounded-sketch shadow-handcrafted">
                          {event.category}
                        </span>
                        <Clock className="w-4 h-4 text-light-foreground/50 dark:text-dark-foreground/50" />
                      </div>
                    ...
                    <div className="space-y-2 mt-4">
                      ...
                      <button className="w-full py-2 border border-light-secondary dark:border-dark-secondary text-light-secondary dark:text-dark-secondary font-sans font-medium hover:bg-light-secondary dark:hover:bg-dark-secondary hover:text-white transition-all duration-300 rounded-handcrafted shadow-handcrafted text-sm mt-3">
                        View Details
                      </button>
                    </div>
                  </div>
        ...
        {/* Personalization CTA */}
        <section className="bg-light-muted dark:bg-dark-muted border border-light-border dark:border-dark-border rounded-handcrafted p-8 shadow-handcrafted">
          <div className="text-center mb-8">
            ...
            <h2 className="font-display font-bold text-2xl text-light-foreground dark:text-dark-foreground mb-4">
              Make Your Recommendations Even{' '}
              <span className="text-light-secondary dark:text-dark-secondary">
                Better
              </span>
            </h2>
            <p className="font-sans text-base text-light-foreground/70 dark:text-dark-foreground/70 mb-8 max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="mb-8">
            <h3 className="font-display font-semibold text-lg text-light-foreground dark:text-dark-foreground mb-6 text-center">
            ...
            <div className="flex flex-wrap gap-3 justify-center max-w-6xl mx-auto">
              {eventTypes.map((type) => (
                <button
                  ...
                  className={`px-4 py-2 border font-sans font-medium transition-all duration-300 rounded-handcrafted shadow-sketch hover:animate-sketch flex items-center space-x-2 text-sm ${
          ...
          <div className="text-center">
            <p className="font-sans text-sm text-light-foreground/70 dark:text-dark-foreground/70 mb-6 max-w-4xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-6 py-3 bg-light-secondary dark:bg-dark-secondary text-white font-sans font-semibold hover:opacity-90 transition-all duration-300 rounded-handcrafted shadow-handcrafted hover:animate-sketch text-sm">
                Save Preferences
              </button>
              <Link
                to="/profile"
                className="px-6 py-3 bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border text-light-foreground dark:text-dark-foreground font-sans font-medium hover:bg-light-muted dark:hover:bg-dark-muted transition-all duration-300 rounded-handcrafted shadow-handcrafted text-sm"
              >
                Update Profile
              </Link>
              <Link
