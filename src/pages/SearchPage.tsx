  ...
  return (
    <div className="pt-24 min-h-screen">
      <div className="max-w-8xl mx-auto px-8 sm:px-12 lg:px-16">
        ...
        {/* Search & Filters */}
        <div className="bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border rounded-handcrafted p-6 mb-12 shadow-handcrafted">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="font-display font-semibold text-lg text-light-foreground dark:text-dark-foreground">
          ...
          {events.map((event) => (
            ...
            >
              ...
              <div className="p-4 space-y-3">
                ...
                <button className="w-full py-2 bg-light-secondary dark:bg-dark-secondary text-white font-sans font-semibold hover:opacity-90 transition-all duration-300 rounded-handcrafted shadow-handcrafted hover:animate-sketch text-sm">
                  View Details
                </button>
              </div>
            </div>
        ...
        <div className="text-center mt-8">
          <button className="px-6 py-3 bg-light-card dark:bg-dark-card rounded-handcrafted text-light-foreground dark:text-dark-foreground font-sans font-medium border border-light-border dark:border-dark-border hover:bg-light-muted dark:hover:bg-dark-muted transition-all duration-300 shadow-handcrafted text-sm">
            Load More Events
          </button>
        </div>
      </div>
